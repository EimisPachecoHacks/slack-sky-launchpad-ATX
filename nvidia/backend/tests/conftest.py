...
os.environ["STORAGE_BACKEND"] = "local"  # Never contact a real object store in unit tests
# Isolate credentials and Terraform workspaces from the developer's real home
# directory so unit tests cannot discover or use local cloud credentials.
os.environ["SKYRCHITECT_HOME"] = tempfile.mkdtemp(prefix="sky-launchpad-tests-")
