...
class TestConfigValidation:
    ...
    def test_secret_values_are_excluded_from_repr(self):
        """A failed assertion must never print live API credentials."""
        from backend.config import Settings
        ...
        assert "test-qwen-secret" not in rendered
        assert "test-gitlab-secret" not in rendered
