...
SAMPLE = {
    ...
    "errors_solutions": [
        {
            "error_signature": "Compute Engine API has not been enabled (compute.googleapis.com)",
            "root_cause": "The compute.googleapis.com service was not enabled on the project.",
            "solution": "Add a google_project_service resource enabling compute.googleapis.com before any compute resources.",
            "provider": "gcp",
            "learned_at": "2026-06-25T18:12:00Z",
            "reused_count": 3,
            "slug": "gcp-enable-compute-api",
        },
        {
            "error_signature": "Bucket name already owned (HTTP 409)",
            "root_cause": "GCS bucket names are globally unique; the chosen name was already taken.",
            "solution": "Suffix bucket names with the project id or a short random hash to guarantee uniqueness.",
            "provider": "gcp",
            "learned_at": "2026-06-25T19:03:00Z",
            "reused_count": 2,
            "slug": "gcp-unique-bucket-name",
        },
        {
            "error_signature": "Invalid value for field 'network': VPC not found",
            "root_cause": "The subnetwork referenced a VPC that had not been created yet (missing dependency).",
            "solution": "Add an explicit depends_on from the subnetwork to the VPC so Terraform orders creation correctly.",
            "provider": "gcp",
            "learned_at": "2026-06-26T09:41:00Z",
            "reused_count": 2,
            "slug": "gcp-vpc-dependency-order",
        },
    ],
    "timeline": [
        {"ts": "2026-06-25T18:11:30Z", "phase": "failure", "text": "terraform apply failed: Compute Engine API has not been enabled", "provider": "gcp"},
        {"ts": "2026-06-25T18:11:45Z", "phase": "diagnose", "text": "Gemma 4 repair agent read the cloud logs and identified the disabled API", "provider": "gcp"},
    ...
    "observability": {
        ...
        "by_model": [
            {"model": "gemma-4-31b-it (AMD MI300X)", "calls": 9, "errors": 0, "avg_latency_ms": 2400.0},
