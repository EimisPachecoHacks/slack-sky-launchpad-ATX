...
export function homeView({ health = null, skills = null, recents = [] } = {}) {
  const blocks = [
    ...
    { type: 'section', text: mrkdwn('Turn plain English or an architecture diagram into *deployed cloud infrastructure* — designed, coded, and applied with Terraform, powered by Qwen.') },
    {
      type: 'actions',
      elements: [
